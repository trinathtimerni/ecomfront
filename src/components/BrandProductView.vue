<template>
  <div class="col-lg-9 mt-4">
    ...
    <div class="right-side">
      <div
        class="product-grid"
        v-for="(product, index) in brand_products"
        :key="index"
      >
...
export default {
  ...
  asNavFor: '.slider-for'
    ...
    guest_id: '',
    items: [
        'Price Low to High', 'Price High to Low', 'Newness', 'Popularity','Rating'
    ],
     apiArg: {
          brand_id: "",
        }
  ...
  methods: {
    ...
    AddCart(item) {
      ...
      else if(localStorage.getItem("guest_id") != null){
